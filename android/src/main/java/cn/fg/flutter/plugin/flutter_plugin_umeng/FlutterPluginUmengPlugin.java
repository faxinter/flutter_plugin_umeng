package cn.fg.flutter.plugin.flutter_plugin_umeng;
 ...
 */
public class FlutterPluginUmengPlugin implements MethodCallHandler {
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter_plugin_umeng");
        channel.setMethodCallHandler(new FlutterPluginUmengPlugin(registrar.activity()));
    }

    private FlutterPluginUmengPlugin(Activity activity) {
        this.activity = activity;
        this.getTestDeviceInfo(activity);
    }
    ...
    public void getTestDeviceInfo(Context context) {
        ...
        Log.i("umeng", deviceIdForGeneral + "   " + deviceMac);
    }
